...
from dsg_compliance.domains.dsg.chunking import chunk_articles, chunk_decisions
from dsg_compliance.domains.dsg.ingestion.edoeb import Decision
from dsg_compliance.domains.dsg.ingestion.fedlex import Article
...
class TestChunkDecisions:
    ...
    def test_chunk_id_is_stable_across_process_restarts(self):
        ...
        script = (
            "from dsg_compliance.domains.dsg.chunking import chunk_decisions;"
            "from dsg_compliance.domains.dsg.ingestion.edoeb import Decision;"
            "from datetime import date;"
